...
11. **Modul 3**: `avatar.html` (audio-reaktiver PNGtuber/Masken-Avatar) — erst Mikro-Permission-Spike auf dem echten Tablet (Streamlabs-Mobile-WebView-Verhalten ungetestet), dann volles CSS/SVG-Maskendesign. Höchste technische Unsicherheit im ganzen Projekt, bewusst zuletzt eingeplant.
